...
public class MiniStatement extends JFrame implements ActionListener {
	...
	public MiniStatement(int atno1, int acno1, int pno1, String actype1) {
		...
		l3.setBounds(100, 250, 70, 20);
		jf.add(l3);

		l31 = new JLabel(strdate);
		l31.setFont(f1);
		l31.setForeground(Color.WHITE);
		l31.setBounds(100, 270, 150, 20);
		jf.add(l31);
		l31.setText(strdate);
		...
		l4.setBounds(250, 250, 70, 20);
		jf.add(l4);

		l41 = new JLabel(strtime);
		l41.setFont(f1);
		l41.setForeground(Color.WHITE);
		l41.setBounds(250, 270, 150, 20);
		jf.add(l41);

		l5 = new JLabel("ATM NO");
		l5.setFont(f1);
		l5.setForeground(Color.WHITE);
		l5.setBounds(380, 250, 110, 20);
		jf.add(l5);

		l51 = new JLabel();
		l51.setFont(f1);
		l51.setForeground(Color.WHITE);
		l51.setBounds(380, 270, 300, 20);
		jf.add(l51);
		...
		l6.setBounds(100, 500, 130, 20);
		jf.add(l6);

		l61 = new JLabel();
		l61.setFont(f1);
		l61.setForeground(Color.WHITE);
		l61.setBounds(230, 500, 150, 20);
		jf.add(l61);

		l7 = new JLabel("For more information Visit our nearest branch of SRN Bank.");
		l7.setFont(f1);
		l7.setForeground(Color.WHITE);
		l7.setBounds(60, 520, 690, 20);
		jf.add(l7);

		l8 = new JLabel("Visit www.srnbank.com or call Toll free no 017********.");
		l8.setFont(f1);
		...
		try {
			...
			ps1 = con.prepareStatement("select * from transaction where atmno='" + atno + "' and accno='" + acno
					+ "' order by trid desc limit 11");
			rs = ps1.executeQuery();
			int r = 0;
			rs.last();
			while (rs.previous()) {
				model.insertRow(r++,
						new Object[] { rs.getString(7), rs.getString(4), rs.getString(5), rs.getString(6) });
