	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == t) {
			...
			if (((p1.getText()).equals("")) && ((p2.getText()).equals("")) && ((p3.getText()).equals(""))) {
				JOptionPane.showMessageDialog(this, "Please enter old PIN no 1 times and new PIN no 2 times !",
						"Warning", JOptionPane.WARNING_MESSAGE);
				sound.play();
			} else if ((Integer.parseInt(p2.getText())) != (Integer.parseInt(p3.getText()))) {
				JOptionPane.showMessageDialog(this, "Please enter New PIN no & confirm PIN no same !", "Warning",
				...
				try {
					...
					ps = con.prepareStatement("select * from accountdetail where atmno='" + atno + "' and accno='"
							+ acno + "' and acctype='" + actype + "' and pinno='" + pingiv + "' ");
					rs = ps.executeQuery();
					while (rs.next()) {
						foundrec = 1;
					}
