...
public class BalanceEnquiry extends JFrame implements ActionListener {
	...
	public BalanceEnquiry(int atno1, int acno1, int pno1, String actype1) {
		...
		l4.setBounds(250, 300, 70, 30);
		jf.add(l4);

		l41 = new JLabel(strtime);
		l41.setFont(f1);
		l41.setForeground(Color.WHITE);
		l41.setBounds(250, 340, 150, 30);
		jf.add(l41);

		l5 = new JLabel("ATM NO");
		l5.setFont(f1);
		l5.setForeground(Color.WHITE);
		l5.setBounds(380, 300, 110, 30);
		jf.add(l5);

		l51 = new JLabel();
		l51.setFont(f1);
		l51.setForeground(Color.WHITE);
		l51.setBounds(380, 340, 300, 30);
		jf.add(l51);

		l6 = new JLabel("Available Balance in BDT: ");
		l6.setFont(f1);
		l6.setForeground(Color.WHITE);
		l6.setBounds(100, 400, 370, 30);
		jf.add(l6);

		l61 = new JLabel();
		l61.setFont(f1);
		l61.setForeground(Color.WHITE);
		l61.setBounds(380, 400, 270, 30);
		jf.add(l61);

		l7 = new JLabel("Thank You For Banking With SRN BANK. For more information,");
		l7.setFont(f);
		l7.setForeground(Color.GRAY);
		l7.setBounds(100, 500, 650, 20);
		jf.add(l7);

		l8 = new JLabel("Please call: 017*********  or  Visit www.srnbank.com ");
		l8.setFont(f);
		l8.setForeground(Color.GREEN);
		l8.setBounds(100, 530, 650, 30);
		jf.add(l8);

		b1 = new JButton("Cancel", new ImageIcon("images//cancel2.png"));
		b1.setFont(f);
		b1.setBounds(280, 600, 130, 40);
		jf.add(b1);
		...
		t = new Timer(200000000, this);// 20 minisecond
		// t.start();
